...
$listitems=["Warmup","Basic cardio", "Medium intensity cardio", "Low intensity cardio", "Low intensity interval", "High intensity interval", "Insane intensity interval", "Flat zone spinning", "Hill climb spinning"];
...
<body>
    ...
    <p>Color <input type="color" name="age" /></p>
    ...
    <div>
        <ul id="pickables" class="list-group-item">
            ...
            foreach ($listitems as $item){
                echo "<li draggable='true'> $item</li>\n";
            }
             ?>
